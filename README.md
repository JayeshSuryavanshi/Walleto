...
| Use | Value |
|---|---|
| **Wallet login** | `james@walleto.app` / `James#123` |
...
| Send money to another wallet | recipient `josephine@walleto.app` |

> Demo users follow the pattern `<firstname>@walleto.app` / `<Firstname>#123` (passwords must be ≥ 8 chars).
