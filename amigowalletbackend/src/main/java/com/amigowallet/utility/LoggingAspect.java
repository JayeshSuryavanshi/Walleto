...
public class LoggingAspect {
	 ...
	 * <br>
	 * In the statement <i>@AfterThrowing(pointcut = "execution(* com.amigowallet.dao.*Impl.*(..))", throwing = "exception")</i>
	 * the point cut expression matches all the methods
	 * with any parameters of DAO classes.
	 * 
	 */
	@AfterThrowing(pointcut = "execution(* com.amigowallet.dao.*.*(..))", throwing = "exception")	
...
//		throw new Exception("DAO.TECHNICAL_ERROR");
	 ...
	 * 
	 * In statement <i>@AfterThrowing(pointcut = "execution(* com.amigowallet.service.*Impl.*(..))", throwing = "exception")</i>
	 * the point cut expression matches all the 'Impl' methods with any parameters of service classes and validator classes.
	 * 
	 */
	@AfterThrowing(pointcut = "execution(* com.amigowallet.service.*Impl.*(..))", throwing = "exception")	
	 ...
	 * location "Desktop/log/AmigoWalletLogger.log"
	 * 
	 * @param exception
	 */
